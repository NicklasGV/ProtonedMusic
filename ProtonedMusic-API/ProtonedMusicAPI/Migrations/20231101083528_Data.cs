    ...
    public partial class Data : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1, new DateTime(2023, 11, 1, 9, 35, 28, 426, DateTimeKind.Local).AddTicks(2660), "Test", 249.95m, new DateTime(2023, 5, 2, 23, 23, 0, 0, DateTimeKind.Unspecified), "Test" },
                    { 2, new DateTime(2023, 11, 1, 9, 35, 28, 426, DateTimeKind.Local).AddTicks(2674), "Test2", 546.95m, new DateTime(2023, 9, 17, 13, 20, 0, 0, DateTimeKind.Unspecified), "Test2" }
                });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1, new DateTime(2023, 11, 1, 9, 35, 28, 601, DateTimeKind.Local).AddTicks(843), "Sorry if you lost important data or something funny, but hey whoever needed to resetting the database needed it. You can see under here when it last got reset", "SERVER GOT RESET" },
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1, "Test Vej 1", "Test By", "Denmark", "testmail1", "Joey", "Test", "$2b$10$OpaJ7.EZaOGXTR8ofdAMhecvLw7RgiLWo7lsgDxadn6TamgKcfC3u", 12345678, 1234, "", 1 },
                    { 2, "Test Vej 2", "Test By", "Denmark", "testmail2", "Børge", "Jep", "$2b$10$q/xOXBMEINVXWF3tcI3X2OgPeZEJFDZk6.8BOewXKwS9H4XYcWj4G", 12345679, 1234, "", 0 }
                });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[] { 1, new DateTime(2023, 11, 1, 9, 35, 28, 601, DateTimeKind.Local).AddTicks(916), 1, 1 });
