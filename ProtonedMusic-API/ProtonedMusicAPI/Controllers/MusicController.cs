namespace ProtonedMusicAPI.Controllers
{
    ...
    public class MusicController : ControllerBase
    {
        ...
        [HttpPost]
        [Route("create")]
        public async Task<IActionResult> CreateAsync([FromBody] MusicRequest newMusic, IFormFile song, IFormFile file)
        {
            try
            {
                ...
                if (song != null)
                {
                    MusicResponse musicSong = await _musicService.UploadSong(musicResponse.Id, song);
                ...
                if (file != null)
                {
                    MusicResponse musicPicture = await _musicService.UploadSongPicture(musicResponse.Id, file);
